...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String HEADER_TRANSACTION_ID_DEFAULT = "catalogue-trace-transaction-id";
	 ...
	 * handleValidationException(BadRequestException e, WebRequest request) {
	 * 
	 * ErrorResponse errorResponse = new ErrorResponse();
	 * errorResponse.setDescription(e.getMessage());
	 * errorResponse.setTransactionId(request.getHeader(
	 * HEADER_TRANSACTION_ID_DEFAULT));
	 * errorResponse.setError(HttpStatus.BAD_REQUEST.name());
	 * errorResponse.setMessage(HttpStatus.BAD_REQUEST.name());
	 * 
	 ...
	 * HttpHeaders headers, HttpStatus status, WebRequest request) { ErrorResponse
